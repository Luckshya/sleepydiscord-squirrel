...
public :
    ...
    CMessage(std::string channelID, std::string author, std::string authorNick, std::string authorID, std::vector<SleepyDiscord::Snowflake<SleepyDiscord::Role>>& roles, std::string message) {
